...
export function InputRounded({ data, handleData, error, name, icon }) {
    ...
    return (
        <>
            <View className={`w-full rounded-full border-2 border-slate-300 px-6 py-2 relative bg-white flex flex-row justify-between items-center my-2 ${focus && "border-[#F97316]"} ${error && "border-red-500"}` }>
